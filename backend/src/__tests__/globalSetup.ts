...
module.exports = async () => {
  ...
  // Cria uma conexão temporária para criar o banco de dados de teste
  ...
  try {
    ...
    // Tenta criar o banco de dados de teste
    try {
      await tempDataSource.query(`CREATE DATABASE advsac_test`);
